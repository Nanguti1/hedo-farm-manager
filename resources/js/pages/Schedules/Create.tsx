...
import type { ScheduleFormData, Task } from '@/types/farm';

interface PageProps {
    tasks: Pick<Task, 'id' | 'title'>[];
}

export default function ScheduleCreate({ tasks }: PageProps) {
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Add Entry', href: '/schedules/create' },
            ]}
        >
            <Head title="Add Schedule Entry" />

            <div className="mx-auto max-w-2xl space-y-6">
                <div>
                    <h1 className="text-3xl font-bold">Add Schedule Entry</h1>
                    <p className="text-muted-foreground">Create a new event, task, or reminder</p>
                </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                className="mt-1"
                                placeholder="e.g. Vet visit, Harvest day"
                            />
                        ...
                        {tasks.length > 0 && (
                            <div>
                                <Label htmlFor="related_task_id">Linked Task (optional)</Label>
                                <Select

...
import type { Animal, AnimalFormData } from '@/types/farm';
...
export default function AnimalEdit({ animal, breeds, categories }: PageProps) {
    const { data, setData, put, processing, errors } = useForm<AnimalFormData>({
        tag_number: animal.tag_number,
        name: animal.name || '',
        breed_id: animal.breed.id,
        category_id: animal.category.id,
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Edit', href: `/animals/${animal.id}/edit` },
        ]}>
            <Head title={`Edit ${animal.tag_number}`} />

            <div className="max-w-2xl mx-auto space-y-6">
                <div>
                    <h1 className="text-3xl font-bold">Edit Animal</h1>
                    <p className="text-muted-foreground">Update animal information</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow">
                    ...
                    <div className="flex justify-end gap-3">
                        <Button
                            ...
                            asChild
                        >
                            <Link href={`/animals/${animal.id}`}>Cancel</Link>
                        </Button>
